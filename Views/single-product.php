                ...
                <div class="row">
                        ...
                        <div class="swiper-container zoom-top">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <img class="img-responsive m-auto" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$get_product['0']['producto_imagen']?>" alt="">
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                        <div class="product-details-content quickview-content ml-25px">
                            <h2><?php echo $get_product['0']['producto_nombre']?></h2>
                            <div class="pricing-meta">
                                <ul class="d-flex">
                                    <li class="new-price"><?php echo $get_product['0']['producto_precio']?></li>
                                </ul>
                            </div>
                            ...
                            <p class="mt-30px"><?php echo $get_product['0']['producto_sdescripcion']?></p>
